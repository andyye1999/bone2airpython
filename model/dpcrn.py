...
class Encoder(nn.Module):
    ...
    def __init__(self, auto_encoder=True):
        ...
        self.conv_2 = nn.Conv2d(16, 32, kernel_size=(2, 3), stride=(1, 2), padding=(1, 1))
...
class Real_Decoder(nn.Module):
    def __init__(self, auto_encoder=True):
        ...
        self.real_dconv_1 = nn.ConvTranspose2d(160, 64, kernel_size=(2, 3), stride=(1, 1))
        ...
        self.real_dconv_4 = nn.ConvTranspose2d(64, 16, kernel_size=(2, 3), stride=(1, 2))
...
class Imag_Decoder(nn.Module):
    def __init__(self, auto_encoder=True):
        ...
        self.imag_dconv_1 = nn.ConvTranspose2d(160, 64, kernel_size=(2, 3), stride=(1, 1))
        ...
        self.imag_dconv_4 = nn.ConvTranspose2d(64, 16, kernel_size=(2, 3), stride=(1, 2))
...
class DPCRN(nn.Module):
    ...
    def forward(self, x):
        ...
        # snr_estimated=self.estimator(dprnn_out_1)
