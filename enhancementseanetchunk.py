...
parser.add_argument("-C", "--config", default= "F:\\yhc\\bone\\config\\enhancement\\seanet.json", type=str, help="Model and dataset for enhancement (*.json).")
parser.add_argument("-D", "--device", default="-1", type=str, help="GPU for speech enhancement. default: CPU")
parser.add_argument("-O", "--output_dir", default= "F:\\yhc\\bone\\enhanced\\seanet3", type=str, help="Where are audio save.")
parser.add_argument("-M", "--model_checkpoint_path", default= "F:\\yhc\\bone\\seanet3\\checkpoints\\best_model.tar", type=str, help="Checkpoint.")
