...
from util.utils import sample_fixed_length_data_aligned,normalize_data,normalize_data_ss,sample_fixed_length_data_alignedss
...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.mode == "train":
            ...
            mixture = sample_fixed_length_data_alignedss(mixture, self.sample_length)
            return mixture.reshape(1, -1), filename, max_bone
        else:
            return mixture.reshape(1, -1), filename, max_bone
