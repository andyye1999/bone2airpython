...
parser.add_argument("-C", "--config", default= "F:\\yhc\\bone\\config\\enhancement\\dccrnsmall8k.json", type=str, help="Model and dataset for enhancement (*.json).")
parser.add_argument("-D", "--device", default="-1", type=str, help="GPU for speech enhancement. default: CPU")
parser.add_argument("-O", "--output_dir", default= "F:\\yhc\\bone\\enhanced\\dccrn8k", type=str, help="Where are audio save.")
parser.add_argument("-M", "--model_checkpoint_path", default= "F:\\yhc\\bone\\dccrn8ksmall\\checkpoints\\best_model.tar", type=str, help="Checkpoint.")
...
for mixture,  name, max_bone in tqdm(dataloader):
    ...
    for chunk in mixture_chunks:
        ...
        out_real, target_real, out_imag, target_imag, out_wav = model(chunk, tmp)
