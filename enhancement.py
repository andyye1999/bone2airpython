...
parser.add_argument("-C", "--config", default= "/home/dsp/yhc/bone/config/enhancement/lstmenhance.json", type=str, help="Model and dataset for enhancement (*.json).")
...
parser.add_argument("-M", "--model_checkpoint_path", default= "/home/dsp/yhc/bone/lstm/checkpoints/best_model.tar", type=str, help="Checkpoint.")
