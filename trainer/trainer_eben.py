...
from trainer.base_trainer_eben import BaseTrainer
...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        self.writer.add_scalar(f"Train/genLoss", gen_loss_total / dl_len, epoch)
        self.writer.add_scalar(f"Train/disLoss", dis_loss_total / dl_len, epoch)
