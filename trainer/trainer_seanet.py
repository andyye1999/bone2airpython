...
from trainer.base_trainer_seanet import BaseTrainer
...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for i, (mixture, clean, filename) in enumerate(self.train_data_loader):
            ...
            if train_gen:
                loss_rec_time = F.l1_loss(enhanced_speech, clean, reduction="mean")
                loss_rec_mel = self.loss2(enhanced_speech, clean)
