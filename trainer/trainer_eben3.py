...
from trainer.base_trainer_eben3 import BaseTrainer
...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for i, (mixture, clean, name, max_bone, max_air) in enumerate(self.train_data_loader):
            ...
            gen_loss = self.loss_function(enhanced_speech, clean)
        ...
        self.writer.add_scalar(f"Train/Loss", gen_loss_total / dl_len, epoch)
